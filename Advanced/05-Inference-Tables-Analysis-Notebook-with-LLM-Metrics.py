...
dbutils.widgets.text("endpoint", f"gpt_endpoint_advanced_{catalog}_{db}"[:63], label = "Name of Model Serving Endpoint")
endpoint_name = f"gpt_endpoint_advanced_{catalog}_{db}"[:63]
...
# NOTE: If you're receiving an error about using the wrong delta table, run cell below to remove it and start fresh
...
streaming_query = (requests_with_metrics.writeStream
...
# checkpoint_location = 'dbfs:/Volumes/main/rag_chatbot_callum_elder/volume_databricks_documentation/checkpoints/payload_metrics'
