...
# MAGIC
# MAGIC CREATE TABLE IF NOT EXISTS prototype.rag_chatbot_zhuoyang_zhao.armhub_pdf_documentation (
...
# MAGIC
# MAGIC DESCRIBE DETAIL prototype.rag_chatbot_zhuoyang_zhao.armhub_pdf_documentation
