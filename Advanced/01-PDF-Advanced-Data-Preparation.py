...
while True:
    ...
    for message in messages:
        try:
            ...
            volume_location = f"/Volumes/prototype/armbot/armbot-docs/{file_path}"
            ...
            with open(volume_location, 'rb') as file:
                ...
                embedded_df = exploded_df.select("url", "basename", "content", get_embedding("content").alias("embedding"))
                
                delta_table_path = "prototype.rag_chatbot_zhuoyang_zhao.armhub_pdf_documentation"
