...
# MAGIC
# MAGIC CREATE TABLE IF NOT EXISTS main.rag_chatbot_callum_elder.1000_50_experimental (
...
# MAGIC
# MAGIC DESCRIBE DETAIL main.rag_chatbot_callum_elder.1000_50_experimental
...
def read_as_chunk(batch_iter: Iterator[pd.Series]) -> Iterator[pd.Series]:
    ...
    splitter = SentenceSplitter(chunk_size=1000, chunk_overlap=50) # CHANGE FOR EACH EXPERIMENT
...
bge_embedding = deploy_client.predict(endpoint="databricks-bge-large-en", inputs={"input": ["What is Apache Spark?"]})
    ...
    if file_name.endswith(".pdf"):
        ...
        try:
            with open(file_path, 'rb') as file:
                ...
                delta_table_path = "main.rag_chatbot_callum_elder.1000_50_experimental"
...
VECTOR_SEARCH_ENDPOINT_NAME = "1000_50_experimental_vector_search"
...
source_table_fullname = "main.rag_chatbot_callum_elder.1000_50_experimental"
...
vs_index_fullname = "main.rag_chatbot_callum_elder.1000_50_experimental_bge_self_managed_vs_index"
...
# Where we want to store our index
vs_index_fullname = "main.rag_chatbot_callum_elder.1000_50_experimental_ada_self_managed_vs_index"
...
# Where we want to store our index
vs_index_fullname = "main.rag_chatbot_callum_elder.1000_50_experimental_openai_large_self_managed_vs_index"
