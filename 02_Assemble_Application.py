...
question = "tell me about the acceleratoring female founders program"
...
class QABot():
  ...
  def __init__(self, llm, retriever, prompt):
    ...
    self.abbreviations = { # known abbreviations we want to replace
      ...
      "ARM": "Advanced Robitics and Manufacturing",
...
queries = pd.DataFrame({'question':[
  "tell me about armhub?",
  "where is armhub located?",
  "which companies are associated with armhub?"
]})
